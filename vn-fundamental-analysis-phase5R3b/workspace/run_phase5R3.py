...
COHORT = [
    ...
    ("HBC", [2020,2021,2022]),  # negative EPS
    ("DDM", [2023,2024,2025]),  # negative equity
]
PEERS = {
...
if __name__ == "__main__":
    ...
    sys.exit(0 if live_ok == len(COHORT) and replay_stable == len(COHORT) and tieout_pass >= 15 else 1)
