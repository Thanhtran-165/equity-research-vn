...
<section id="why-not" data-layer="public">
  ...
  <p>Thứ nhất: dữ liệu theo ngày có khoảng 25.000 phiên — rất nhiều — và vẫn không thấy lợi suất đi trước. Nếu tín hiệu dẫn trước tồn tại ở tần suất ngày, dữ liệu đủ để bắt. Thứ hai: ngay cả nghiên cứu trước đây với dữ liệu lớn hơn cũng không cho dự báo ổn định ngoài mẫu.</p>
  ...
  <details data-layer="technical">
    ...
    <div class="body">
      ...
      <p>Kết quả chiều bond→equity: 0/150 daily + 0/150 monthly vẫn đứng vững sau kiểm tra nghiêm ngặt FWER 5%. Không có cấu hình nào cho thấy lợi suất đi trước cổ phiếu ở bất kỳ tần suất nào.</p>
      <p>Chiều equity→bond chưa được kiểm định trong Chương 2 (scope gap — không kết luận null). Chương 4 có 7 test mix 2 chiều (4 bond→equity + 3 equity→bond), p_adj_holm toàn = 1,0 → 0/7 reject.</p>
...
<section id="method" data-layer="public">
  ...
  <details data-layer="technical"><summary>Cách kiểm tra khả năng đi trước</summary><div class="body">
      ...
      <p>Chiều bond→equity: 300 rows (150 daily + 150 monthly), trên 15 chỉ số × 5 biến lợi suất × 2 tần suất. P-values hiệu chỉnh Holm FWER 5% trong từng family.</p>
      <p>Chiều equity→bond: chưa được kiểm định trong Chương 2 (scope gap). Đây là giới hạn thiết kế — nếu chiều ngược tồn tại dẫn trước, nghiên cứu không phát hiện được.</p>
  ...
  <details data-layer="technical"><summary>Giới hạn dữ liệu và survivorship</summary><div class="body">
      ...
      <p>Common driver chưa được kiểm định trực tiếp. Chiều equity→bond chưa test Ch2 (scope gap).</p>
    </div></details>
