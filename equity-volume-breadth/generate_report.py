...
def add_master_navigation(markup):
    ...
    chapter = master + "/chapters/participation.html"
    ...
    banner = f'''<aside class="master-report-bar" aria-label="Báo cáo tổng hợp"><div class="master-report-bar__inner"><span>Chuyên khảo 02 thuộc bộ Nghiên cứu thị trường Việt Nam</span><span class="master-report-bar__links"><a href="{master}">Đọc báo cáo tổng hợp</a><a href="{chapter}">Xem chương này trong master</a></span></div></aside>'''
...
def main():
    ...
    v, sm, oos, tl = load()
    html = add_master_navigation(gen_html(v, sm, oos, tl))
